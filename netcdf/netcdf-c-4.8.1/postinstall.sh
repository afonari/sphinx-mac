...
if [ "x$DOAUTOTOOL" = "xTRUE" ]; then
    ...
    if [ "x$DOACTION" = "xbuild" ]; then
        ...
        LIBS="-lm -lz -lcurl " CFLAGS="-I/Users/fonari/src/sphinx-mac/netcdf/netcdf-c-4.8.1/install_dn/include" LDFLAGS="-L/Users/fonari/src/sphinx-mac/netcdf/netcdf-c-4.8.1/install_dn/lib" ./configure --prefix=/Users/fonari/src/sphinx-mac/netcdf/netcdf-c-4.8.1/install_dn $STATIC_BUILD $SHARED_BUILD
        LIBS="-lm -lz -lcurl " make
        LIBS="-lm -lz -lcurl " make check
    fi
