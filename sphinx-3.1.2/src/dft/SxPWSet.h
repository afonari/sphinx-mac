  ...
  public SxThis<SxPWSet>
{
   public:
       ...
       */
      virtual const PsiRef operator() (int i, int iSpin, int ik) const
         =0;
      ...
      /** \brief returns a single Bloch-like state
          ...
          \return  state \f$\langle\bf{G+k}|\Psi_{i,\sigma,\bf{k}}\rangle\f$
       */
      virtual PsiRef operator() (int i, int iSpin, int ik)
         =0;
      ...
      /** \brief returns Bloch-like states
          ...
          \return  state \f$\langle\bf{G+k}|\Psi_{i,\sigma,\bf{k}}\rangle\f$
       */
      virtual const PsiG& operator() (int iSpin, int ik) const;
      /** \brief returns Bloch-like states
          This function will be used from the SxPWHamiltonian to get
          the Bloch-like states with the spin quantum number \f$\sigma\f$, 
          and at the \b k point k
          ...
          \return  state \f$\langle\bf{G+k}|\Psi_{i,\sigma,\bf{k}}\rangle\f$
       */
      virtual PsiG& operator() (int iSpin, int ik);
      ...
      /** \brief Derefences the wavefunction as a matrix {ng x nBlock}
        ...
        \param ik      k-index
      */
      virtual PsiRef getBlock (int iStart, int nBlock, int iSpin, int ik);

      /// Returns a single Bloch state (autoloop)
      template<class T1, class T2, class T3>
      const PsiRef operator() (const T1 &i,
                                       const T2 &iSpin,
                                       const T3 &ik) const
      {
         ...
         return const_cast<SxPWSet*>(this)->operator() ((int)i, (int)iSpin, (int)ik);
      }
      
      /// Returns a single Bloch state (autoloop)
      template<class T1, class T2, class T3>
      PsiRef operator() (const T1 &i,
                                       const T2 &iSpin,
                                       const T3 &ik)
      {
         SxAutoLoop::setLimit (i, getNStates ((int)ik));
      ...
      const PsiG& operator() (const SxAutoLoop &iSpin,
      ...
      /// returns Bloch-like states (autoloop)
      PsiG& operator() (const SxAutoLoop &iSpin,
                                  const SxAutoLoop &ik)
      {
         iSpin.setLimit (getNSpin ());
         ik.setLimit (getNk ());
