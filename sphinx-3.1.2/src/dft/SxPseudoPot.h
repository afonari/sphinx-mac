...
class SX_EXPORT_DFT SxPseudoPot : public SxSpeciesData
{
   public:
      ...
      SxArray<SxVector<double> >             rad; // :iSpecies,:r
      SxArray<SxArray<SxVector<double> > >   pseudoPsi; // :iSpecies,:l,:r
      SxArray<SxArray<SxVector<double> > > getPseudoPsi (const SxRadBasis *basisPtr = NULL);
      const SxVector<double>& getPseudoPsi (int is, int l) const;
      SxArray<SxArray<SxVector<double> > >   pseudoPot; // :iSpecies,:l,:r
      ...
      SxArray<SxArray<SxVector<double> > >     foccAtomicRho;  // :iSpecies,:l,:iSpin
      bool                                     nlcc;
