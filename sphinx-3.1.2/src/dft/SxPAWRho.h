...
class SX_EXPORT_DFT SxPAWRho : public SxDensity
{
   public:
      ...
      /** Set up an aspherical atomic charge density according to input table
          @param structure  the underlying atomic structure
          @param potPtrIn   the PAW potentials (to be kept)
          @param R          real-space mesh basis
          @param nSpin      number of spin channels
        */
      void asphericalAtomCharge (const SxSymbolTable *table,
