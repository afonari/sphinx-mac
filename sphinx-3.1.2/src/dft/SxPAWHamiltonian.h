...
class SX_EXPORT_DFT SxPAWHamiltonian : public SxHamiltonian
{
   public:
      ...
      virtual void compute (const SxFermi &, bool tauChanged=true, bool rhoChanged=true);
   ...
   public:
      ...
      SxArray<SxVector<PrecCoeffG> > vBarG;

      /// rhoCorePS in G-space (:is)
      SxArray<SxVector<PrecCoeffG> > rhoCorePSG;
      ...
      */
      SxVector<SxComplex16> getHnm (const PsiRef &waveBlock) const;
      ...
      */
      SxVector<PrecCoeffG> computeRhoHatG (int is, int ia,
      ...
      /// Check that interatomic distances are not much below PAW cutoffs
