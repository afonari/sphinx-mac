\thispagestyle{empty}\vspace*{.2\textheight}


\begin{flushright}
\textbf{\Huge \includegraphics[width=5cm]{/scratch/c.freysoldt/devel/sx-src/sphinx/sxaccelerate/src/share/manual/images/logo.eps}}
\par\end{flushright}{\Huge \par}

\begin{flushright}
\textbf{\Huge SxAccelerate 2.11.13}
\par\end{flushright}{\Huge \par}
