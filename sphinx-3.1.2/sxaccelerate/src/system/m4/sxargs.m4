...
[AC_ARG_ENABLE([$1],
AS_HELP_STRING([--enable-$1], [$4 (default=$3)]),
...
[AC_ARG_WITH([$1],
AS_HELP_STRING([--with-$1], [$5 (default=$4)]),
...
currentdir=`pwd`
cd $1 
eval "$sx_topsrc/$1/configure --disable-option-checking $2 $ac_configure_args" || AC_MSG_ERROR([Failed to configure $1])
cd $currentdir
])
