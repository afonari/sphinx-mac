...
#ifndef _SX_GPU_COMPUTE_WRAPPERS_H_
#define _SX_GPU_COMPUTE_WRAPPERS_H_

#include <SxMath.h>
#include <SxComplex.h>

#ifdef USE_GPU
// --- The next 740 lines were generated from snippets/computeGPU.h snippet BINOP
...
void addGPU (float* resPtr, ssize_t n,
      const float* xPtr, const float* yPtr, int gpuId = -1);
...
void addGPU (double* resPtr, ssize_t n,
      const double* xPtr, const double* yPtr, int gpuId = -1);
...
void addGPU (SxComplex8* resPtr, ssize_t n,
      const SxComplex8* xPtr, const SxComplex8* yPtr, int gpuId = -1);
...
void addGPU (SxComplex16* resPtr, ssize_t n,
      const SxComplex16* xPtr, const SxComplex16* yPtr, int gpuId = -1);
...
void addGPU (int* resPtr, ssize_t n,
      const int* xPtr, const int* yPtr, int gpuId = -1);
...
void divideInPlaceGPU (int* xPtr, const int* yPtr,
      ssize_t n, int gpuId = -1);
// --- BINOP
// --- The next 88 lines were generated from snippets/computeGPU.h snippet matmult
...
#endif /* _SX_GPU_COMPUTE_WRAPPERS_H_ */
